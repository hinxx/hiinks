    ...
    def iProp(self, iName):
        ...
        for child in root:
            ...
            if child.tag == self.tag and child.get('name') == iName:
                iLog.debug("Found element value=%s" % (iName))
                return child
            ...
            if child.tag == self.tag and child.get('name') == iName:
                ...
                for prop in child:
                    ...
                    if prop.tag == iTag:
                        ...
                        prop.text = iValue
                        iLog.debug("New value element tag=%s, value=%s" % (prop.tag, prop.text))
                        return True
    ...
    def iSetAttribute(self, iName, iValue, iTag):
        ...
        for child in root:
            ...
            if child.tag == self.tag and child.get('name') == iName:
                ...
                iLog.debug("New value attribute attr=%s, value=%s" % (iTag, child.get(iTag)))
                return True
